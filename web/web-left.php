...
<html>
  ...
  <body onload="">
  <img width="100" height="100" src="images/ScreenClip.jpg">
  ...
  <?
	...
	echo "<select name=student size=20 ONCHANGE='top.frames['web-main'].location.href = this.options[this.selectedIndex].value;'>";
...
<br>
<br>
<A Href="../member_sys/mylist"><img src="images/home2.gif" width="100" height="100"></A>
 </body>
</html>
